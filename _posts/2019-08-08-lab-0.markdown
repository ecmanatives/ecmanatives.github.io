...
In the peak of its development the new implementation had features like:
...
just some improvements from the experience of using version 3
...
Brendan used the word "Harmony" in the conclusions of his mail. This harmony
would become the name for the future place of new JavaScript ideas. "ECMAScript
Harmony" was born. 

Adobe implemented a big bunch of features from ES4 into ActionScript and kept
maintaining it for a while for its own "Flash".

Before the end of ES4 a small spinoff was created called E4X, it featured some
nice patches for XML parsing, was introduced into SpiderMonkey, but was removed
for lack of use.

ECMAScript 5 became the long sought rebirth of JavaScript. It included:
...
It was released in different browsers between 2011 and 2012.
