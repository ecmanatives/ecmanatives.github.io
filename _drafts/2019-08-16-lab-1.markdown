...
Open a new terminal screen and execute the command to pop into a 
NodeJS REPL shell.
...
- both [] and {} have the type of 'object'. This is a bit missleading though as
  [] is still officially called an `Array` (and receives the special functions
  from Array).
...
Sweet! Now let's open our functions.js from the sidebar of Atom.
